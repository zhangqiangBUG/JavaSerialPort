package com.zqbug.serialport.manage;
...
import com.zqbug.serialport.exception.ReadDataFromSerialPortFailure;
import com.zqbug.serialport.exception.SendDataToSerialPortFailure;
import com.zqbug.serialport.exception.SerialPortInputStreamCloseFailure;
import com.zqbug.serialport.exception.SerialPortOutputStreamCloseFailure;
import com.zqbug.serialport.exception.SerialPortParameterFailure;
import com.zqbug.serialport.exception.TooManyListeners;
import com.zqbug.serialport.utils.ArrayUtils;
...
public class SerialPortManager {
	 ...
	 * @return 读取到的数据 
	 */  
	public static String readFromPortS(SerialPort serialPort) {  
	    InputStream in = null;  
	    byte[] bytes = {};  
	    try {  
	        in = serialPort.getInputStream();  
